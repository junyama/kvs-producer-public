...
public:
    MyGstreamer *gstreamerPtr;

    WSListener(); //constructor w/o a parameter
    WSListener(MyGstreamer *gstreamerPtr); //constructor with a parameter
...
public:
    ...
    std::shared_ptr<WSListener> wsLinstener;
    
    MyGstreamer *gstreamerPtr =  nullptr;

    //Constructors
    WSInstanceListener();                            //constructor w/o a parameter
    WSInstanceListener(MyGstreamer *gstreamerPtr);  //constructor with a parameter
